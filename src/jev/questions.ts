  ...
  insight_density: {
    ...
    build: (p, ctx) => ({
      ...
      criteria: [
        ...
        "Good; several specific ideas backed by evidence or examples, but all available in standard references or a summary",
        "Dense; original data, derivations, measurements or first-hand experience that a reader could not get from a summary",
      ],
    }),
  },
